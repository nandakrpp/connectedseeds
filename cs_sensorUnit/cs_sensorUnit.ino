 ...
 * Example sketches of all required I2C and SPI components. 
 * 
 * 
...
const char APIWriteKey2[] = "4AWCI7EHQD77WCTB"; //  Seeds Guardian 2: Anwara's
const char APIWriteKey3[] = "524ZTB61SU12AYI6"; //  Seeds Guardian 3: Lisa's green house
const char APIWriteKey4[] = "1LQ6Q1WTYEUDBP7T"; //  Seeds Guardian 4: Richard's Gren orach
const char APIWriteKey5[] = "ZGH0R6DZUPP0YHP0"; //  Seeds Guardian 5: Nat Cordwainers
const char APIWriteKey6[] = "Y4VH8P3A5OA4HRH9"; //  Seeds Guardian 6: [ready to be deployed]
const char APIWriteKey7[] = "1DF2QTGZ56FUY7BW"; //  Seeds Guardian 7: Lutfun's Kudo
const char APIWriteKey8[] = "SRK068R7WYKB7H35"; //  Seeds Guardian 8: Halema's
const char APIWriteKey9[] = "IOSOY1K8O46476YP"; //  Seeds Guardian 9: Sara's garden
const char APIWriteKey10[] = "4M3GVWJCZW5VM609"; //  Seeds Guardian 10: [got stolen]
const char APIWriteKey11[] = "9DW38T9X73JPRXZM"; //  Seeds Guardian 11: Normadic garden [to be deployed]
const char APIWriteKey12[] = "KRE3CJMZKCRSCDXQ"; // Seeds Guardian 12: Zimbabwean association's
const char APIWriteKey13[] = "C15N1JL5B3BARQI9"; //  Seeds Guardian 13: [ready to be deployed]
const char APIWriteKey14[] = "KSFFZXSE18PEWNE2"; //  Seeds Guardian 14: [ready to be deployed]
const char APIWriteKey15[] = "TVOVWA76JAW3CAWC"; //  Seeds Guardian 15: Debbie & Lisa 2
