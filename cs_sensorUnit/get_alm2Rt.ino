void get_alm2Rt(void)
{
  ...
  else
  {
    ...
    // **********************************************************
    //    send_sms1Num1Msg_assign_para(1, 1); // phone num, msg num
    //    delay(ONESEC * 5);
    //    send_sms1Num1Msg_assign_para(2, 1); // phone num, msg num
    //    delay(ONESEC * 5);
  ...
  if (modeBattVolt < V_THRES)
  {
    ...
    send_sms1Num1Msg_assign_para(1, 2); // phone num, msg num
    delay(ONESEC * 5);
    send_sms1Num1Msg_assign_para(2, 2); // phone num, msg num
    delay(ONESEC * 5);
